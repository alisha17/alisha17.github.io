---
layout: post
title: "Chatbot to send automatic notifications in MS Teams chat"
author: alisha
...
hidden: true
---
I have never been a fan of Microsoft Teams but I recently started 
using Power Automate to send automatic notifications in chat. These notifications can
be triggered from an external source or by simply sending a POST request to a webhook
(this depends on your use case though!)

My use case was sending notifications to people in chat (one-on-one, not in a channel)
after their assets were flagged with high vulnerabilites. Emails are good for this purpose,
but important emails can often get lost in stacks of non-important emails, so sending direct messages
in Teams seemed like a good idea.
